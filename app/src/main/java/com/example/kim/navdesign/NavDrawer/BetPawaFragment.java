 ...
 */
public class BetPawaFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater , ViewGroup container ,
        ...
        ((MainActivity) getActivity ()).setActionBarTittle ( "Betpawa.co.ke" );
        ...
        webView.loadUrl ( "https://betpawa.co.ke/" );
