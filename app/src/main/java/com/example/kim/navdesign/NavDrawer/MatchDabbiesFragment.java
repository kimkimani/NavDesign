 ...
 */
public class MatchDabbiesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater , ViewGroup container ,
        ...
        ((MainActivity) getActivity ()).setActionBarTittle ( "MatchDabbies" );
        ...
        webView.loadUrl ( "http://tipsscorepro.com/match-dabbies/" );
