 ...
 */
public class BetwayFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater , ViewGroup container ,
        ...
        ((MainActivity) getActivity ()).setActionBarTittle ( "Betway.co.ke" );
        ...
        webView.loadUrl ( "https://www.betway.co.ke/" );
