 ...
 */
public class IxBetFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater , ViewGroup container ,
        ...
        ((MainActivity) getActivity ()).setActionBarTittle ( "1xbet.co.ke" );
        ...
        webView.loadUrl ( "https://m.1xbet.co.ke/?whn=desctop" );
