 ...
 */
public class NaijaFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater , ViewGroup container ,
        ...
        ((MainActivity) getActivity ()).setActionBarTittle ( "Bet9ja.com" );
        ...
        webView.loadUrl ( "https://mobile.bet9ja.com/Mobile#/" );
